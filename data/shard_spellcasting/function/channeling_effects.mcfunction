...
execute as @a[tag=tomeOfEssentials,tag=!channelingComplete,scores={channeling=100..,shard=1},nbt={Dimension: "minecraft:overworld"}] run function shard_spellcasting:effects/tome_of_essentials_spawn

# Process Tome in the Overworld
execute as @a[tag=tomeOfEssentials,tag=!channelingComplete,scores={channeling=100..,positionY=43..,shard=2..},nbt={Dimension: "minecraft:overworld"}] run function shard_spellcasting:effects/tome_of_essentials
execute at @a[tag=tomeOfEssentials,tag=!channelingComplete,scores={channeling=100..,positionY=..42,shard=2..},nbt={Dimension: "minecraft:overworld"}] run function shard_spellcasting:particles/casting_failed
