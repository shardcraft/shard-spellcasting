...
execute if entity @s[nbt={Inventory: [{Slot: -106b, tag: {display: {Lore: ['{"text":"Summons a small rainstorm."}']}}}]}] run clear @s minecraft:paper[lore=['{"text":"Summons a small rainstorm."}']] 1
