...
# Teleport.
execute at @s run execute as @e[distance=..2,type=!minecraft:armor_stand,type=!item_frame,type=!glow_item_frame] run execute in minecraft:overworld run tp @s -4961.5 64 2169.5 0 0
